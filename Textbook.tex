...
\begin{figure}[h]
	...
	\centering\includegraphics[width=.45\textwidth]{/Chapter2/Figure_Linus}
\end{figure}
...
\begin{itemize}
	...
	\texttt{https://www.continuum.io/downloads}. Before downloading, make sure that you don't already have Anaconda Python installed on your system. To do this press \keys{Win} + \keys{R} to open the ``Run'' dialog window. In the input field, type \texttt{powershell}. Then type \texttt{python} from within the PowerShell command line window. If you see a response from the Anaconda Python interpreter then Anaconda is already installed (if the interpreter does not identify itself as "Anaconda" Python, then you have only base Python installed. You will need to install Anaconda).
	...
	To verify that Anaconda Python has been installed, open PowerShell and type the command \texttt{python}. Python should now launch. To exit, type \texttt{quit()} and press \keys{Enter}.
\end{itemize}
...
\begin{figure}[h]
	...
	\centering\includegraphics[width=.80\textwidth]{/Chapter8/Figure_1}
\end{figure}
...
\begin{figure}[h]
	...
	\centering\includegraphics[width=.80\textwidth]{/Chapter8/Figure_2}
\end{figure}
...
\begin{figure}[h]
	...
	\centering\includegraphics[width=.80\textwidth]{/Chapter8/Figure_3}
\end{figure}
...
\begin{figure}[h]
	...
	\centering\includegraphics[width=.80\textwidth]{/Chapter8/Figure_4}
\end{figure}
...
\begin{figure}[h]
	...
	\centering\includegraphics[width=.80\textwidth]{/Chapter8/Figure_5}
\end{figure}
