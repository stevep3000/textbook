...
\section{Reverting a repository to an earlier commit}
...
\begin{enumerate}
	...
	\item A command line shell. We will be using this tool to interact with the Python interpreter. The shell we will be using is Windows Powershell\textsuperscript{\textregistered}. You already have experiencing working with a command line shell from Chapter 2.
\end{enumerate}
